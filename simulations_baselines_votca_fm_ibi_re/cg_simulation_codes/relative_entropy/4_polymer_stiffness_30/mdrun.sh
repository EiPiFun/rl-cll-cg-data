...
$gmx_name grompp -f equilibrium.mdp -c relaxation-1-4.gro -r relaxation-1-4.gro -p topol.top -n index.ndx -o equilibrium.tpr $grompp_appendix
$mpirun_prefix $gmx_name mdrun -deffnm equilibrium -ntmpi $ntmpi_number -ntomp $ntomp_number $mdrun_appendix
