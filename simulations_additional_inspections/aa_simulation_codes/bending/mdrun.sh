...
$gmx_name grompp -f deform.mdp -c relaxation-1-4.gro -r relaxation-1-4.gro -p topol.top -n index.ndx -o deform.tpr $grompp_appendix
$mpirun_prefix $gmx_name mdrun -deffnm deform -ntmpi $ntmpi_number -ntomp $ntomp_number $mdrun_appendix
$gmx_name grompp -f stretch.mdp -c deform.gro -r deform.gro -p topol.top -n index.ndx -o stretch.tpr $grompp_appendix
