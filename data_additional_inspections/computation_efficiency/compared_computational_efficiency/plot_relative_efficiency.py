...
chart_ylabel = 'Relative efficiency'
...
legend_array = ('CG(CPU)/AA(CPU)','CG(CPU)/AA(CPU+GPU)')
...
plt.bar(x1-0.05, y3/y1, width=0.1)
plt.bar(x1+0.05, y3/y2, width=0.1)
...
plt.savefig(current_path+'computational_efficiency_relative.'+image_file_extension)
