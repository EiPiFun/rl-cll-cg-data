...
y1 = numpy.array((0.583,0.781,0.854,1.085))
y2 = numpy.array((0.873,0.953,0.977,1.023,1.225))
...
plt.savefig(current_path+'brick_strength.'+image_file_extension)
