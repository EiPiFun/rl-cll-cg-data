...
output_image_file_location = current_path+strain_stress_data_file_name+'_with_reference.'+image_file_extension
...
stress_data = -0.0001*(raw_strain_stress_data[:,stress_column])
...
matplotlib.pyplot.ylim(-0.2, 1.4)
